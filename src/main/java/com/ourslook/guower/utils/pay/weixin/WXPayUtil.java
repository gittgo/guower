...
import static com.ourslook.guower.utils.pay.weixin.WXPayConstants.FIELD_SIGN;
...
public class WXPayUtil {
     ...
     * @return 签名
     */
    public static String generateSignatureByMapInSha1(Map<String, Object> map) throws Exception {
        ArrayList<String> list = new ArrayList<String>();
        int index = 1;
        for(Map.Entry<String,Object> entry:map.entrySet()){
            if(entry.getValue()!=""){
                String d = entry.getKey() + "=" + entry.getValue() + "&";
                list.add(d);
                index++;
            }
        }
