...
import com.ourslook.guower.entity.ColumnEntity;
import com.ourslook.guower.entity.TableEntity;
...
import static com.ourslook.guower.utils.SqlResultUtil.paraseObjToInt;
...
public class GenUtilsMySql {
    ...
    public static List<String> getTemplates(){
        ...
        templates.add("template/Dao.Mysql.xml.vm");
        templates.add("template/Service.java.vm");
        templates.add("template/ServiceImpl.java.vm");
        templates.add("template/Controller.java.vm");
        templates.add("template/list.html.vm");
        //templates.add("template/list.js.vm");
        templates.add("template/list.layerui.js.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for(Map<String, String> column : columns){
            ...
            columnEntity.setNullable("YES".equalsIgnoreCase(column.get("is_nullable")));
            columnEntity.setMaxLength(paraseObjToInt(column.get("CHARACTER_MAXIMUM_LENGTH")));
    ...
    public static String getFileName(String template, String className, String packageName){
        ...
        if(template.contains("Dao.Mysql.xml.vm") || template.contains("Dao.Oracle.xml.vm")){
        ...
        if(template.contains("list.layerui.js.vm")){
