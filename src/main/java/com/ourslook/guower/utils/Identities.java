...
public class Identities {
    ...
    /**
     * 生成订单号（16位）,避免首位为0的情况；长度不要改
     *
     * @return
     */
    public static String getRandomOrderNo() {
        return getBeanNumber(1, 9) + "" + getRandomString(15);
    }
    ...
    public static String getBatchOrderNo() {
        return DateUtils.getCurrentDateSimple() + Identities.getRandomNumber(5);
    }
     ...
     * @return
     */
    public static String getDjOrderNo() {
        return "8888" + getRandomNumberNo0Stat(10);
    }
     ...
     * @return
     */
    public static String getAgDemandNo() {
        return "PR" + getRandomNumberNo0Stat(10);
    }
     ...
     * @return
     */
    public static String getAgOrderNo(){
        return "PO" + getRandomNumberNo0Stat(10);
    }
     ...
     * @return
     */
    public static String getAgScheduleNo(){
        return "DP" + getRandomNumberNo0Stat(10);
    }
     ...
     * @return
     */
    public static String getKpOrderNo() {
        return "22" + getRandomNumberNo0Stat(2);
    }
    /**
     * 生成固定长度的随机字符和数字
     *
    ...
    public static String getJcQjLX(int s,int e){
        return  getBeanNumber(s,e)+"."+getRandomNumberNo0Stat(2);
    }

//    public static void main(String[] args) {
//        System.out.println("Identities.getRandomOrderNo() = "  + getRandomOrderNo() + "");
//    }
