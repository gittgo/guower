 ...
 *
 * @author Lingo
 * @see com.ourslook.guower.utils.XaUtils
 *
 * @see Base64Utils
...
public class EncodeUtils {
    ...
    public static String htmlEscape(String html) {
        return StringUtilss.escapeHtml(html);
    }
    ...
    public static String htmlUnescape(String htmlEscaped) {
        return StringUtilss.unescapeHtml(htmlEscaped);
    }
    ...
    public static String xmlEscape(String xml) {
        return StringUtilss.escapeXml(xml);
    }
    ...
    public static String xmlUnescape(String xmlEscaped) {
        return StringUtilss.unescapeXml(xmlEscaped);
    }
    ...
    public static boolean isISO_8859_1(String key) {
        if (key == null) {
            return false;
        }
        return java.nio.charset.Charset.forName("ISO-8859-1").newEncoder().canEncode(key);
    }
}
