 ...
 */
@Configuration
@MapperScan("com.ourslook.guower.dao")
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() {
        ...
        //扫描entity包 使用别名
        sqlsession.setTypeAliasesPackage("com.ourslook.guower.entity");
        ...
        try {
            if (DruidConfig.DBTYPE_ORACLE.equalsIgnoreCase(dbType)) {
                sqlsession.setMapperLocations(resolver.getResources("classpath:mapper/oracle/**/*.xml"));
            } else {
                sqlsession.setMapperLocations(resolver.getResources("classpath:mapper/mysql/**/*.xml"));
