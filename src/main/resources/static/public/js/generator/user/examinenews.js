$(function () {
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#jqGrid'
            , url: getWebPath() + 'busnews/list?releaseType=2'
            //, width: 1100
            //, height: 488
            , cellMinWidth: 80
            ...
            , cols: [[
                ...
                , {field: 'examineType', minWidth: 120, title: '审核类型',fixed:'right', align: 'center', sort: true,templet : function(data){
        ...
        methods: {
            ...
            examineBox : function(){
                ...
                for (var i = 0; i < selectRows.length; ++i) {
                    if(selectRows[i].examineType != null && selectRows[i].examineType != 0){
                        alert("已审核过的不可再次审核");
                        return ;
                    }
                ...
                //询问框
                layer.confirm('文章是否通过审核？', {
                    btn: ['通过','未通过'] //按钮
                }, function(){
                    vm.examineCheck.result = 1;
                    $.ajax({
                        type: "POST",
                        url: getWebPath() + "busnews/examine",
